<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="Viewitem.aspx.cs" Inherits="Viewitem" %>
...
<!-- AddThis Button END -->
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        BorderWidth="0px" DataSourceID="AccessDataSource2" Width="100%" 
    AllowPaging="True">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
